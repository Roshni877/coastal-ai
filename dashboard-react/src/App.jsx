...
export default function App() {
    ...
    useEffect(() => {
        const dataUrl = `${import.meta.env.BASE_URL}coastal_environmental_dataset.csv`;
        fetch(dataUrl)
            .then(res => {
                if (!res.ok) throw new Error(`Dataset file not found (${res.status} ${res.statusText})`);
                return res.text();
            })
            .then(csvText => {
                Papa.parse(csvText, {
                    ...
                    complete: (results) => {
                        if (results.data && results.data.length > 0) {
                            ...
                            setFetchError("Dataset CSV was empty or invalid.");
                        }
                        setIsLoading(false);
                    },
                    error: (err) => {
                        setFetchError(`CSV Parsing Error: ${err.message}`);
                        setIsLoading(false);
                    }
                });
            })
            .catch(err => {
                ...
                setFetchError(err.message || "Failed to fetch dataset");
                setIsLoading(false);
            });
    }, []);
    ...
    return (
        <React.Fragment>
            ...
            {!isLoading && fetchError && (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', color: '#ff2a6d', textAlign: 'center', padding: '20px' }}>
                    <ShieldAlert size={48} style={{ marginBottom: '16px' }} />
                    <h2>Dataset Loading Error</h2>
                    <p style={{ color: '#a0aec0', maxWidth: '500px', marginTop: '8px' }}>{fetchError}</p>
                    <button 
                        onClick={() => window.location.reload()} 
                        style={{ marginTop: '20px', padding: '10px 20px', borderRadius: '6px', background: '#00f0ff', color: '#090d16', border: 'none', fontWeight: 'bold', cursor: 'pointer' }}
                    >
                        Retry Loading
                    </button>
                </div>
                ...
                <div className="app-container">
                        ...
                        <div className="sidebar-section">
                            ...
                            <div className="control-group">
                                <div className="control-label">
                                    ...
                                    <span className="val-badge">{tanBeta.toFixed(3)}</span>
                                </div>
                                <input 
                                    type="range" 
                            ...
                            <div className="control-group">
                                <div className="control-label">
                                    ...
                                    <span className="val-badge">{HMean.toFixed(1)} m</span>
                                </div>
                                <input 
                                    type="range" 
                                    className="custom-slider" 
                            ...
                            <div className="control-group">
                                <div className="control-label">
                                    ...
                                    <span className="val-badge">{tideHeight.toFixed(1)} m</span>
                                </div>
                                <input 
                                    type="range" 
                                    className="custom-slider" 
                    ...
                    <main className="main-content">
                        ...
                        >
                            ...
                            <motion.div className="stat-card accent-indigo" whileHover={{ y: -4 }}>
                                <div className="card-header">
                            ...
                            <motion.div className="stat-card accent-magenta" whileHover={{ y: -4 }}>
                                <div className="card-header">
                            ...
                            <motion.div className="stat-card accent-emerald" whileHover={{ y: -4 }}>
                                <div className="card-header">
